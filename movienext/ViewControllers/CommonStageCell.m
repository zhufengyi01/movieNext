...
-(void)CreateTopView0
{
    ...
    UserNameLable =[ZCControl createLabelWithFrame:CGRectMake(35, 10, 140, 20) Font:14 Text:@"名字"];
    UserNameLable.textColor=VGray_color;
    [BgView0 addSubview:UserNameLable];
    
    TimeLable =[ZCControl createLabelWithFrame:CGRectMake(35, 25, 140, 20) Font:14 Text:@"时间"];
