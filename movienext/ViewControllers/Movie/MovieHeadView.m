...
-(void)createUI
{
    ...
    UIButton  *btn1=[ZCControl createButtonWithFrame:CGRectMake(0, kDeviceHeight/3-45, kDeviceWidth/2, 45) ImageName:@"" Target:self Action:@selector(dealChangeModelClick:) Title:@""];
    [btn1 setImage:[UIImage imageNamed:@"single_switch@2x"] forState:UIControlStateNormal];
    btn1.tag=1000;
    [self addSubview:btn1];
    
    UIButton  *btn2=[ZCControl createButtonWithFrame:CGRectMake(kDeviceWidth/2, kDeviceHeight/3- 45, kDeviceWidth/2, 45) ImageName:@"" Target:self Action:@selector(dealChangeModelClick:) Title:@""];
