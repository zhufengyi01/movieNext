...
-(void)createUI
{
    ...
    //导演
    derectorLable=[ZCControl createLabelWithFrame:CGRectMake(0,0,100,30) Font:12 Text:@"导演"];
    [self addSubview:titleLable];
    //演员
    performerLable=[ZCControl createLabelWithFrame:CGRectMake(0, 0, 100, 30) Font:12 Text:@"演员"];
