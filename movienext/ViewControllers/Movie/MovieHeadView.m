...
-(void)createUI
{
    ...
    movieLogoImageView  =[[UIImageView alloc]initWithFrame:CGRectMake(15, 64+20+170, 50, 50)];
...
//    performerLable.textColor=[UIColor whiteColor];
    ...
    UIView  *btnBg =[[UIView  alloc] initWithFrame:CGRectMake(0, kDeviceHeight/3+64-45+110, kDeviceWidth, 45)];
