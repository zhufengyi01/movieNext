...
- (void)createUI {
    ...
    _ivLike = [[UIImageView alloc]initWithFrame:CGRectMake(m_frame.size.width-33, 8, 9, 8)];
    ...
    _lblLikeCount = [[UILabel alloc]initWithFrame:CGRectMake(m_frame.size.width-20,5, 20, 15)];
    _lblLikeCount.text=@"";
